...
namespace VOM
{
    ...
    private:
         ...
         */
        static std::shared_ptr<interface_ip6_nd> find_or_add(const interface_ip6_nd &temp)
        {
         ...
         */
        friend class VOM::singular_db<key_t, interface_ip6_nd>;
        ...
        /**
         * A map of all interface ip6 nd keyed against a combination of the interface
         * and subnet's keys.
         */
    ...
    singular_db<typename interface_ip6_nd<CLASS, CMD>::key_t,
                interface_ip6_nd<CLASS, CMD> > interface_ip6_nd<CLASS, CMD>::m_db;
